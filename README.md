...
_This application is more compatible with Android, not with the iOS, macOS or Windows_
...
### ✅ Latest Update: Advanced Budgeting Tools (v2.0.0) 🎯
ExTrack has been transformed from a passive expense tracker into a proactive financial planning tool with:
- **Category-based Budgets**: Set spending limits for specific categories with real-time tracking
- **Smart Notifications**: Get alerts when approaching or exceeding budget limits (50%, 75%, 90%, 100%)
- **Budget Analytics**: Visual progress bars, spending velocity predictions, and performance insights
- **Intelligent Suggestions**: AI-powered recommendations to optimize spending and stay within budget
- **Budget Templates**: Pre-configured budgets for different lifestyles (student, family, professional)
- **Rollover Options**: Flexible budget periods with unused amounts carrying forward

### Additional Planned Features
- Cloud synchronization across devices
- Data backup and restore functionality
- Financial goals setting and monitoring
- Advanced reports and exports in various formats
- Multiple currency support with exchange rates
- Recurring transaction templates
- Spending pattern analysis and insights
- Budget challenges and gamification elements
